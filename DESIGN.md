...
The app shell provides a fixed desktop sidebar, sticky topbar, responsive main region, and fixed mobile navigation. Lazy-loaded routes cover Home, Weather, Todos, Tools, Bookmarks, Settings, and a calm not-found state.
