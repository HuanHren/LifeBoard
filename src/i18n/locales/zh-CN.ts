...
export const zhCN = {
  ...
  'landing.hero.kicker': '安静的个人生活操作系统',
  'landing.hero.title': 'LifeBoard 让每日上下文始终触手可及。',
  'landing.hero.description':
    '一个本地优先的每日工作台，整合天气氛围、计划、私人工具和保存资料。你可以浏览产品叙事，也可以随时直接进入应用。',
  'landing.cta.enterWorkspace': '进入工作台',
  'landing.cta.explore': '浏览叙事',
  'landing.story.kicker': '安静的操作层',
  'landing.story.title': '天气、计划、资料和工具共同形成每日上下文。',
  'landing.story.description':
    'Landing 介绍 LifeBoard，但不成为门槛。每个场景预览真实应用区域，核心路由仍可直接进入。',
  'landing.story.weather.eyebrow': '天气氛围',
  'landing.story.weather.title': '从外部世界开始一天。',
  'landing.story.weather.description':
    '天气用本地状况和安静的视觉氛围建立当天语境，完整 Weather 页面仍是功能事实来源。',
  'landing.story.todos.eyebrow': '计划与倒计时',
  'landing.story.todos.title': '把意图变成下一步可见行动。',
  'landing.story.todos.description':
    '待办和重要日期靠近日常上下文，不需要额外变成复杂项目系统。',
  ...
  'landing.story.tools.description':
    '工具输入保持本地和临时，符合 LifeBoard 长期低疲劳的使用节奏。',
  ...
  'landing.entry.kicker': '直接入口',
  'landing.entry.title': '直接前往需要的页面',
  'landing.entry.description': 'Landing 是产品入口，不是门槛。所有核心应用路由仍可直接访问。',
  'landing.demo.kicker': '局部真实交互',
  'landing.demo.title': '不离开叙事，也能预览工作流。',
  'landing.demo.description':
    'Stage 4 的交互只属于 Landing 本地状态，用来展示产品形态，不读取也不修改应用 Store。',
  'landing.demo.tabLabel': 'Landing 预览模块',
  'landing.demo.weather.title': '带天气意识的开始',
  'landing.demo.weather.description':
    '紧凑天气预览展示产品氛围，但不会导入已冻结的 Weather 模块。',
  'landing.demo.weather.card': '清晰到足够安排下一步。',
  'landing.demo.todos.title': '任务可以就地完成',
  'landing.demo.todos.description': '这个复选框只是 Landing 本地演示状态，不触碰 Todos Store。',
  'landing.demo.todos.sample': '准备下午的专注时段',
  'landing.demo.todos.open': '未完成：任务仍在今日流程中。',
  'landing.demo.todos.done': '已完成：演示状态只在本地改变。',
  'landing.demo.tools.title': '私人工具空间',
  'landing.demo.tools.description': '文本区是临时且浏览器本地的，只用于预览 Tools 的使用节奏。',
  ...
  'landing.final.description':
    'LifeBoard 保持品牌入口可预测：返回 / 会看到产品叙事，/app 和应用路由仍可收藏。',
